...
(function (b) {
    b.fn.pagepiling = function (c) {
        ...
        function g(a, d) {
            ...
            if (p.index(".pp-section") < e) {
                ...
                c.css3 || q.each(function (a) {
                    a != p.index(".pp-section") && b(this).css({top: n})
                });
                var r = p, l = function () {
                }
            ...
            c.css3 ? (t(r,
                ...
                m()
            }, c.scrollingSpeed)) : d ? r.animate({top: n}, c.scrollingSpeed, c.easing, function () {
                l();
                m()
        ...
        function k(a, d) {
            if ("down" == a)var c = "bottom", e = b.fn.pagepiling.moveSectionDown; else c = "top", e = b.fn.pagepiling.moveSectionUp;
            if (0 < d.length)if (isScrolled(c, d))e(); else return !0; else e()
        }
        ...
        function E(a) {
            ...
            a.preventDefault();
            z(a.target) || (a = b(".pp-section.active"), a = w(a), l() || (d = y(d), touchEndY = d.y, touchEndX = d.x, Math.abs(touchStartY - touchEndY) > e.height() / 100 * c.touchSensitivity &&
        ...
        var e = b(this),
            u, v = 0, A = "ontouchstart" in window || 0 < navigator.msMaxTouchPoints;
        c = b.extend({
            menu: null,
            verticalCentered: !0,
            sectionsColor: [],
        ...
        b.fn.pagepiling.setScrollingSpeed =
            function (a) {
                c.scrollingSpeed = a
            };
        ...
        c.css3 && (c.css3 = G());
        b(e).css({overflow: "hidden", "-ms-touch-action": "none", "touch-action": "none"});
